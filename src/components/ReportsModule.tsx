        ...
        <TabsContent value="sales" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">₹{salesData.today.sales.toLocaleString()}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">₹{salesData.week.sales.toLocaleString()}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">₹{salesData.month.sales.toLocaleString()}</div>
                <p className="text-xs text-muted-foreground">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-xl font-bold">₹{gstSummary.totalSales.toLocaleString()}</p>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg">
                    <p className="text-sm text-gray-600">CGST (9%)</p>
                    <p className="text-xl font-bold">₹{gstSummary.cgst.toLocaleString()}</p>
                  </div>
                  <div className="p-4 bg-yellow-50 rounded-lg">
                    <p className="text-sm text-gray-600">SGST (9%)</p>
                    <p className="text-xl font-bold">₹{gstSummary.sgst.toLocaleString()}</p>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg">
                    <p className="text-sm text-gray-600">Total GST</p>
                    <p className="text-xl font-bold">₹{gstSummary.totalGst.toLocaleString()}</p>
                  </div>
                </div>
